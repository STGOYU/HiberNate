...
public class RunnerSave03 {
    ...
    public static void main(String[] args) {
        ...
        student2.setId(1002);
        student2.setName("Ridvan A");
        student2.setGrade(90);

        Student03 student3 =new Student03();
        student3.setId(1003);
        student3.setName("R.Yigit Er");
        student3.setGrade(90);

        Diary diary1 = new Diary();
        diary1.setId(101);
        diary1.setName("Atilgan'in Gunlugu");
        diary1.setStudent(student1); //one to one burada

        Diary diary2 = new Diary();
        diary2.setId(102);
        diary2.setName("Ridvan'in gunlugu");
